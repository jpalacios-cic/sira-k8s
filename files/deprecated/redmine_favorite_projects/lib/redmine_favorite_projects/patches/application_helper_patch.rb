  ...
  module Patches
    module ApplicationHelperPatch
      ...
      module InstanceMethods
        def render_projects_for_jump_box_with_favorites(projects, selected: nil, query: nil)
          ...
          return render_projects_for_jump_box_without_favorites(projects, selected: selected, query: query) unless favorite_projects.any?
